SELECT "view_policy_consolidated"."name", 
       ...
       "viewlatest_rate_increase_notification"."correspondence_type" as "viewlatest_rate_increase_notification_correspondence_type", 
       ...
       "viewlatest_rate_increase_notification"."rate_increase" as "viewlatest_rate_increase_notification_rate_increase", 
	   ...
	   "view_latest_rate_change_notification"."correspondence_type" as "view_latest_rate_change_notification_correspondence_type", 
