SELECT "view_policy_consolidated"."name", 
       "opportunity_ext"."age", 
       "view_policy_consolidated"."name" as "1", 
       "policies_ext"."mer", 
       "policies_ext"."mer_type", 
       "policies_ext"."mer_age", 
       "view_policy_consolidated"."name" as "2", 
       "view_policy_consolidated"."insurancecompany", 
       "policies"."policynumber", 
       "policies"."deathbenefit", 
       "view_policy_consolidated"."name" as "3", 
       "view_policy_consolidated"."name" as "4", 
       "view_policy_consolidated"."name" as "5", 
       "medicalunderwriting"."productname", 
       "view_policy_consolidated"."name" as "6", 
       "view_policy_consolidated"."name" as "7", 
       "view_policy_consolidated"."client", 
       "gmbh"."gmbh_num", 
       "view_policy_consolidated"."name" as "8", 
       ...
       "view_policy_consolidated"."name" as "9", 
       "view_policy_performance_latest"."annualstatementdate", 
       "view_policy_consolidated"."name" as "9.1", 
       "view_policy_consolidated"."name" as "10", 
       "view_policy_consolidated"."name" as "11", 
       ...
       "view_policy_consolidated"."name" as "12", 
       "view_policy_consolidated"."name" as "13", 
       ...
       "view_policy_consolidated"."name" as "14", 
       "view_policy_consolidated"."name" as "15", 
       "view_policy_consolidated"."name" as "16", 
       ...
       "view_policy_consolidated"."name" as "17", 
       ...
       "view_policy_consolidated"."name" as "18", 
       "policies_ext"."product_carrier_will_run_minpa", 
       "view_illustration_latest_select_scenarios_2"."illustration run date" as "view_illustration_latest_select_scenarios_2.illustration run date", 
       "view_policy_consolidated"."name" as "19", 
       ...
       "view_illustration_latest_other"."illustration run date" as "view_illustration_latest_other.illustration run date", 
       ...
       "view_policy_value_stmt_req_latest_voc"."most_recent_received" as "view_policy_value_stmt_req_latest_voc.most_recent_received", 
       ...
       "view_policy_consolidated"."provider" as "view_policy_consolidated.provider", 
       ...
       "view_policy_value_stmt_req_latest_policy_values"."most_recent_received" as "view_policy_value_stmt_req_latest_policy_values.most_recent_received", 
       ...
       "view_best_purchaser_offer_accepted"."provider" as "view_best_purchaser_offer_accepted.provider", 
       "policies"."owner", 
	   ...
	   "view_illustration_latest_select_scenarios"."date request sent to carrier", 
	   "view_illustration_latest_select_scenarios"."illustration run date" as "view_illustration_latest_select_scenarios.illustration run date", 
	   "opportunity_ext"."ssn", 
