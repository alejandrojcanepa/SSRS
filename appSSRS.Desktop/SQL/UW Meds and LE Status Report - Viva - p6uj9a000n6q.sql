SELECT DISTINCT "opportunity"."description", 
                ...
                "opportunity"."description" as "0", 
                "policies"."premiumadvancedate", 
                "policies_ext"."orig_settlement_date", 
                "opportunity"."description" as "1", 
                "opportunity"."description" as "2", 
                "opportunity"."description" as "3", 
                "opportunity"."description" as "4", 
                "view_le_latest_flat_service_viva"."avs_date", 
                "opportunity"."description" as "5", 
                ...
                "opportunity"."description" as "6",
                "opportunity"."description" as "7",
                "view_le_latest_flat_service_viva"."tf_date", 
                "opportunity"."description" as "8",
                ...
                "opportunity"."description" as "9",
                "opportunity"."description" as "10",
                "opportunity"."description" as "11",
                "opportunity"."description" as "12",
                "opportunity"."description" as "13",
                "opportunity"."description" as "14",
                ...
                "opportunity"."description" as "15",
                "opportunity"."description" as "16",
                "view_hipaa_latest_outstanding_hipaa_request"."lastrequest", 
                "view_policy_hipaa_next_send_date"."nexthipaasenddate", 
                "opportunity"."description" as "17",
                "opportunity"."description" as "18",
                "opportunity"."description" as "19",
                "opportunity"."description" as "20",
                "viewlast_aps_visit_date"."last_visit_date", 
                "opportunity"."description" as "21",
                "opportunity"."description" as "22",
                "opportunity"."description" as "23",
                "opportunity"."description" as "24",
                "opportunity"."description" as "25",
