Public Class BankSubmission
    ''' <summary>
    ''' Insured_Age. Obtiene la edad del asegurado
    ''' </summary>
    ''' <param name="dob">Corresponde al campo opportunity_ext.dob</param>
    ''' <param name="submission_date">Corresponde al campo bank_submission.submission_date</param>
    ''' <returns></returns>
    ...
    ''' <param name="dob">Corresponde al campo opportunity_ext.dob</param>
    ''' <param name="submission_date">Corresponde al campo bank_submission.submission_date</param>
    ''' <returns>Un string indicando si es Red (R), Green (G) o Yellow (Y)</returns>
    ...
    ''' DB_Check
    ''' </summary>
    ''' <param name="deathbenefit">Corresponde al campo policies.deathbenefit</param>
    ''' <returns>Un string indicando si es Red (R), Green (G) o Yellow (Y)</returns>
    ...
    ''' Illustration_Date
    ''' </summary>
    ''' <param name="illustration_date_overwrite">Corresponde al campo bank_submission.illustration_date_overwrite</param>
    ''' <param name="illustration_rec_latest">Corresponde al campo view_illustration_latest_scenario1.illustration_rec_latest</param>
    ''' <returns></returns>
    ...
    ''' LE_Age_1
    ''' </summary>
    ''' <param name="certi_date1">Corresponde al campo view_le_for_bank_submission.certi_date1</param>
    ''' <param name="submission_date">Corresponde al campo bank_submission.submission_date</param>
    ''' <returns></returns>
    ...
    ''' LE_Age_2
    ''' </summary>
    ''' <param name="certi_date2">Corresponde al campo view_le_for_bank_submission.certi_date2</param>
    ''' <param name="submission_date">Corresponde al campo bank_submission.submission_date</param>
    ''' <returns></returns>
    ...
    ''' LE_Blend
    ''' </summary>
    ''' <param name="le1">Corresponde al campo view_le_for_bank_submission.le1</param>
    ''' <param name="le2">Corresponde al campo view_le_for_bank_submission.le2</param>
    ''' <returns></returns>
    ...
    ''' LTV
    ''' </summary>
    ''' <param name="loan_amt">Corresponde al campo bank_submission.loan_amt</param>
    ''' <param name="policy_value">Corresponde al campo bank_submission.policy_value</param>
    ''' <returns></returns>
    ...
    ''' MER
    ''' </summary>
    ''' <param name="mat_ext_rider_1_yn">Corresponde al campo policy_audit.mat_ext_rider_1_yn</param>
    ''' <param name="mat_ext_rider_2_yn">Corresponde al campo policy_audit.mat_ext_rider_2_yn</param>
    ''' <returns></returns>
    ...
    ''' Raiting_Check
    ''' </summary>
    ''' <param name="sp">Corresponde al campo view_carrier_latest_rating.sp</param>
    ''' <returns></returns>
    ...
    ''' ROP
    ''' </summary>
    ''' <param name="VPCRop">Corresponde al campo view_policy_consolidated.rop</param>
    ''' <returns></returns>
    ...
    ''' Status_Check
    ''' </summary>
    ''' <param name="policy_status">Corresponde al campo view_premium_latest_by_source_date.policy_status</param>
    ''' <returns></returns>
...
#Region "Métodos Auxiliares: No Copiar a Reporting Services"
    ...
    ''' Product_Check
    ''' </summary>
    ''' <param name="productCheck">Corresponde al campo bank_submission.product_check</param>
    ''' <returns></returns>
    ''' <remarks>
