Public Class UWMedsAndLEStatusReport2_Meridian
    ...
    Function AgeOfAnnivDate(ByVal Anniv__Date As Nullable(Of Date))
    ...
    Function MostCurrentAllRecordsReceivedAge(ByVal all_rec_recv_date As Nullable(Of Date))
